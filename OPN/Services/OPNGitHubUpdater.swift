...
struct OPNReleaseSummary: Sendable, Equatable, Identifiable {
    let version: String
    let tagName: String
...
struct OPNGitHubRelease: Sendable, Equatable {
    let summary: OPNReleaseSummary
...
struct OPNUpdateDownloadProgress: Sendable, Equatable {
...
actor OPNGitHubUpdater {
    ...
    func checkForUpdate(channel: OPNUpdateChannel = .stable) async throws -> OPNGitHubRelease? {
    ...
    private func installableCandidate(channel: OPNUpdateChannel) async throws -> OPNGitHubRelease? {
    ...
    private func latestStableRelease() async throws -> OPNGitHubRelease? {
    ...
    func recentReleases(limit: Int = 8) async throws -> [OPNReleaseSummary] {
    ...
    func installRelease(_ release: OPNGitHubRelease, progress: @escaping @Sendable (OPNUpdateDownloadProgress) -> Void = { _ in }) async throws -> Bool {
    ...
    private func installableRelease(from json: [String: Any]) -> OPNGitHubRelease? {
