...
struct OPNReleaseNotes: Equatable, Sendable {
    ...
    static let empty = OPNReleaseNotes(sections: [], paragraphs: [], compareURL: nil)
...
enum OPNReleaseNotesFormatter {
    private static let fallbackSectionTitle = "Changes"

    static func parse(_ body: String) -> OPNReleaseNotes {
        ...
        let builtSections = sections.enumerated().compactMap { index, draft -> OPNReleaseNotes.Section? in
            ...
            return OPNReleaseNotes.Section(
        ...
        return OPNReleaseNotes(sections: builtSections, paragraphs: paragraphs, compareURL: compareURL)
    }
    ...
    private static func makeEntry(source: String, fallbackID: String) -> OPNReleaseNotes.Entry {
        var text = source
    ...
    private static func kind(for title: String) -> OPNReleaseNotes.Kind {
