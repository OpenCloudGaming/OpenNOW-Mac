...
public struct StreamResolution: Equatable, Sendable {
...
public struct StreamProfile: Equatable, Sendable {
    ...
    public init(resolution: StreamResolution = StreamResolution(width: 1920, height: 1080),
                fps: Int = 60,
                codec: String = "H264",
...
public enum StreamSettingsResolver {
    ...
    static func permittedCodec(profile: StreamProfile,
                               capabilities: StreamDeviceCapabilities,
                               cloudVariables: StreamCloudVariables) -> String {
    ...
    private static func resolvedTarget(profile: StreamProfile,
                                       capabilities: StreamDeviceCapabilities,
                                       cloudVariables: StreamCloudVariables) -> ResolvedTarget {
    ...
    public static func resolve(profile: StreamProfile,
                               capabilities: StreamDeviceCapabilities,
                               cloudVariables: StreamCloudVariables = StreamCloudVariables()) -> ResolvedStreamSettings {
    ...
    private static func resolvedPrefilterMode(profile: StreamProfile, cloudVariables: StreamCloudVariables) -> Int {
    ...
    private static func resolvedCodec(profile: StreamProfile, capabilities: StreamDeviceCapabilities) -> String {
    ...
    private static func codecSupported(_ codec: String, capabilities: StreamDeviceCapabilities) -> Bool {
        switch codec {
        case "AUTO", "H264": true
