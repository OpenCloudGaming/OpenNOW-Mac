...
extension OPNGameDataCache {
    func gameDictionary(_ game: OPNGameInfo) -> [String: Any] {
    ...
    func gameInfo(_ value: Any) -> OPNGameInfo {
    ...
    func variantDictionary(_ variant: OPNGameVariant) -> [String: Any] {
        var dictionary: [String: Any] = [:]
    ...
    func gameVariant(_ value: Any) -> OPNGameVariant {
        let dictionary = value as? [String: Any] ?? [:]
    ...
    func putString(_ value: String, key: String, into dictionary: inout [String: Any]) {
        if !value.isEmpty { dictionary[key] = value }
    }

    func putArray(_ value: [String], key: String, into dictionary: inout [String: Any]) {
