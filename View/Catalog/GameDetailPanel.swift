...
struct GameDetailPanel: View {
    ...
    var selectedVariant: OPNCatalogGameVariantObject? {
        viewModel.selectedVariant(in: viewModel.selectedGame)
    }

    var selectedPlatformOption: CatalogPlatformOption? {
        viewModel.selectedPlatformOption(in: viewModel.selectedGame)
    }

    func primaryActionTitle(game: OPNCatalogGameObject) -> String {
    ...
    func selectedPlatformHasAccess(_ game: OPNCatalogGameObject) -> Bool {
