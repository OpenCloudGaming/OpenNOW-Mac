...
extension OPNDesign {
    nonisolated(unsafe) static var resolvedAccent = color(OPNThemePreferences.AccentColor.cloudGreen.components)
    nonisolated(unsafe) static var resolvedAccentSoft = color(OPNThemePreferences.AccentColor.cloudGreen.components)
    nonisolated(unsafe) static var resolvedAccentInk = color(OPNThemePreferences.AccentColor.cloudGreen.components)
    ...
    static func accentInkColor(components: (red: Double, green: Double, blue: Double)) -> Color {
        ...
        let legible = OPNThemePreferences.legibleAccentComponents(
            red: components.red,
            green: components.green,
            blue: components.blue,
            onSurfaceLuminance: OPNThemePreferences.relativeLuminance(red: surface.red, green: surface.green, blue: surface.blue)
        )
        return color(legible)
    }

    static func applyAccent(_ preset: OPNThemePreferences.AccentColor) {
