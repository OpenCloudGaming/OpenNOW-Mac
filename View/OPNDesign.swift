...
private struct OPNMagnifiedSurfaceMarker: NSViewRepresentable {
...
final class OPNInterfaceScaleDensityView: NSView {
    ...
    private func reconfigure() {
        ...
        let observer = CFRunLoopObserverCreateWithHandler(kCFAllocatorDefault, CFRunLoopActivity.beforeWaiting.rawValue, true, 0) { [weak self] _, _ in
            ...
            guard OPNMagnifiedSurfaceRegistry.shared.isAnySurfaceMagnified else {
                reconfigure()
                return
            }
    ...
    private var walkInterval: CFTimeInterval = OPNInterfaceScaleDensityView.activeInterval
