...
TEST_DEPS := src/streaming/OPNStreamBackend.mm src/streaming/OPNStreamPreferences.mm src/auth/OPNAuthService.mm src/games/OPNGameDataCache.mm src/games/OPNGameService.mm src/common/OPNLocale.mm src/common/OPNSentry.mm
