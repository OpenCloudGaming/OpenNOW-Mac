...
TEST_DEPS := src/streaming/OPNStreamBackend.mm src/streaming/OPNStreamPreferences.mm src/auth/OPNAuthService.mm src/games/OPNGameDataCache.mm src/common/OPNSentry.mm
