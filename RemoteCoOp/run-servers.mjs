...
function buildConfig() {
  ...
  const generatedInviteSecret = !stringEnv("OPENNOW_REMOTE_COOP_INVITE_SECRET", "");
  const inviteSecret = generatedInviteSecret ? randomBytes(32).toString("base64url") : stringEnv("OPENNOW_REMOTE_COOP_INVITE_SECRET", "");
  ...
  const env = {
    ...
    OPENNOW_REMOTE_COOP_TURN_TTL_SECONDS: stringEnv("OPENNOW_REMOTE_COOP_TURN_TTL_SECONDS", "600"),
    OPENNOW_REMOTE_COOP_INVITE_SECRET: inviteSecret,
