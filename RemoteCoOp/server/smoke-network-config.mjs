...
const smokeInviteSecret = process.env.OPENNOW_REMOTE_COOP_INVITE_SECRET || "opennow-remote-coop-smoke-invite-secret";
...
async function startBroker() {
  ...
  brokerProcess = spawn(process.execPath, [brokerScript], {
    ...
    env: {
      ...
      OPENNOW_REMOTE_COOP_INVITE_SECRET: smokeInviteSecret
    }
  });
  if (verbose) {
