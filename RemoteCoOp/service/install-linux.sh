...
write_panel_environment() {
  ...
  INVITE_SECRET=$(env_file_value OPENNOW_REMOTE_COOP_INVITE_SECRET || node -e 'console.log(require("crypto").randomBytes(32).toString("base64url"))')
...
OPENNOW_REMOTE_COOP_INVITE_SECRET=$INVITE_SECRET
EOF
